...
其中间包含一个超薄的窄带隙半导体，带隙大小为 $E_{g1}$，两侧是宽带隙半导体，带隙大小为 $E_{g2}$。这一层被称为限制层 (Confining Layer)，其作用是将电子和空穴限制在量子阱中，从而提高载流子浓度和复合效率。比如两边的半导体材料是 AlGaAs，中间的量子阱部分是一个薄的 GaAs 层。
